...
mod tests {
    ...
    fn cfg(tokens: i64, calls: i32) -> AppConfig {
        ...
        AppConfig {
            ...
            agent_turn_phase_timeout_seconds: 75,
            agent_turn_repair_timeout_seconds: 150,
            agent_turn_authorization_timeout_seconds: 150,
            agent_turn_total_timeout_seconds: 240,
            ...
            post_decision_prompt_max_chars: 80_000,
            post_decision_token_budget: 32_000,
            post_decision_failed_snapshot_retention_days: 14,
