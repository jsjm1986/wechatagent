...
红线（命中即 needs_revision 或拦截，独立于五闸打分）：候选回复承诺"安排真人 / 让同事来直接联系 / 让运营同事整理后回你 / 稍后有人跟你对接 / 转接客服"等把对话或任务交接给第三方（真人、同事、运营、客服）的表达——本产品全程 AI 自治，没有真人接管，引入第三方角色就是失约，必须改写成 AI 自己第一人称长期承接的口吻（如"这块我先核对下准确口径再回你"）。判定标准：是不是引入了"我"之外的人来接手？是→改写；只是"我稍后补充 / 我确认完再回你"这类第一人称兜底→放行。"#,
        },
        PromptSpec {
