...
> 是中间态、这些函数已不存在；现行为分数闸体系（两硬拦 + 三软闸 single-shot revision + R5.4
> 结构化背书，入口 `src/agent/review/gates.rs`）。详见 `requirements.md` 顶部 2026-08-13 现状注记
> 与 `project-understanding/29-doc-code-divergence-master.md`。
